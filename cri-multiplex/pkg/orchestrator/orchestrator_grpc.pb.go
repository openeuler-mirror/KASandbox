...
type SandboxServiceClient interface {
	...
	Update(ctx context.Context, in *SandboxUpdateRequest, opts ...grpc.CallOption) (*empty.Empty, error)
	List(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*SandboxListResponse, error)
	Delete(ctx context.Context, in *SandboxDeleteRequest, opts ...grpc.CallOption) (*empty.Empty, error)
	Pause(ctx context.Context, in *SandboxPauseRequest, opts ...grpc.CallOption) (*empty.Empty, error)
	Checkpoint(ctx context.Context, in *SandboxCheckpointRequest, opts ...grpc.CallOption) (*SandboxCheckpointResponse, error)
	ListCachedBuilds(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*SandboxListCachedBuildsResponse, error)
}
...
func (c *sandboxServiceClient) Update(ctx context.Context, in *SandboxUpdateRequest, opts ...grpc.CallOption) (*empty.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(empty.Empty)
...
func (c *sandboxServiceClient) List(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*SandboxListResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (c *sandboxServiceClient) Delete(ctx context.Context, in *SandboxDeleteRequest, opts ...grpc.CallOption) (*empty.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(empty.Empty)
...
func (c *sandboxServiceClient) Pause(ctx context.Context, in *SandboxPauseRequest, opts ...grpc.CallOption) (*empty.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(empty.Empty)
...
func (c *sandboxServiceClient) ListCachedBuilds(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*SandboxListCachedBuildsResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type SandboxServiceServer interface {
	...
	Update(context.Context, *SandboxUpdateRequest) (*empty.Empty, error)
	List(context.Context, *empty.Empty) (*SandboxListResponse, error)
	Delete(context.Context, *SandboxDeleteRequest) (*empty.Empty, error)
	Pause(context.Context, *SandboxPauseRequest) (*empty.Empty, error)
	Checkpoint(context.Context, *SandboxCheckpointRequest) (*SandboxCheckpointResponse, error)
	ListCachedBuilds(context.Context, *empty.Empty) (*SandboxListCachedBuildsResponse, error)
...
func (UnimplementedSandboxServiceServer) Update(context.Context, *SandboxUpdateRequest) (*empty.Empty, error) {
	return nil, status.Error(codes.Unimplemented, "method Update not implemented")
}
func (UnimplementedSandboxServiceServer) List(context.Context, *empty.Empty) (*SandboxListResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method List not implemented")
}
func (UnimplementedSandboxServiceServer) Delete(context.Context, *SandboxDeleteRequest) (*empty.Empty, error) {
	return nil, status.Error(codes.Unimplemented, "method Delete not implemented")
}
func (UnimplementedSandboxServiceServer) Pause(context.Context, *SandboxPauseRequest) (*empty.Empty, error) {
...
func (UnimplementedSandboxServiceServer) ListCachedBuilds(context.Context, *empty.Empty) (*SandboxListCachedBuildsResponse, error) {
...
func _SandboxService_List_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SandboxServiceServer).List(ctx, req.(*empty.Empty))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _SandboxService_ListCachedBuilds_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SandboxServiceServer).ListCachedBuilds(ctx, req.(*empty.Empty))
	}
	return interceptor(ctx, in, info, handler)
}
