...
// Defines values for AndroidVersion.
const (
	N14 AndroidVersion = "14"
	N15 AndroidVersion = "15"
...
// AndroidVersion Android guest version. Required when osType is android; ignored otherwise.
...
type Sandbox struct {
	...
	// AndroidVersion Android guest version. Required when osType is android; ignored otherwise.
	AndroidVersion *AndroidVersion `json:"androidVersion,omitempty"`
