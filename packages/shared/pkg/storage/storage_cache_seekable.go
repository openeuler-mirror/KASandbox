...
var (
	...
	//_ BufferRegistrar = (*cachedSeekable)(nil)
	//_ BatchReader     = (*cachedSeekable)(nil)
)

// func (c *cachedSeekable) RegisterBuffer(ptr uintptr, size uint64) error {
// 	if registrar, ok := c.inner.(BufferRegistrar); ok {
// 		return registrar.RegisterBuffer(ptr, size)
// 	}
// 	return nil
// }

// func (c *cachedSeekable) UnregisterBuffer(ptr uintptr) error {
// 	if registrar, ok := c.inner.(BufferRegistrar); ok {
// 		return registrar.UnregisterBuffer(ptr)
// 	}
// 	return nil
// }

// func (c *cachedSeekable) BatchReadInto(ctx context.Context, offsets []int64, sizes []int64, ptrs []uintptr) ([]int, error) {
// 	if batchReader, ok := c.inner.(BatchReader); ok {
// 		return batchReader.BatchReadInto(ctx, offsets, sizes, ptrs)
// 	}
// 	return nil, fmt.Errorf("cached seekable inner does not implement BatchReader")
// }
